...
![Spark Kafka](/images/posts/img.jpg)
...
[Kafka as a Storage System](https://kafka.apache.org/intro#kafka_storage) gives us all benefits of the fault-toleran, distributed storage and the throughput of Streaming system.
...
The [Spark-Kafka integraion](https://spark.apache.org/docs/latest/streaming-kafka-0-10-integration.html) provides two ways to consume messages.
...
*You can refer [this post](/java/2017/09/24/import-data-from-csv-files-to-hbase-using-spark.html) for setting up the environment locally.*
...
The source & execution guide is available in [this Git repository](https://github.com/scriperdj/kafka_batch_processing_using_spark_sample) and should be easy to understand if you are already familiar with[ Spark style of programming](https://spark.apache.org/docs/latest/quick-start.html)
