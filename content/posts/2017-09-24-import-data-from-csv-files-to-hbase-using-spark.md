...
**Hadoop**
* Download the distribution from [Apache](http://www.apache.org/dyn/closer.cgi/hadoop/common/) and extract to home. Rename the folder to `hadoop`.
* Modify `core-site.xml` & `hdfs-site.xml` as mentioned in [here](http://hadoop.apache.org/docs/current/hadoop-project-dist/hadoop-common/SingleCluster.html#Pseudo-Distributed_Operation)

**HBase**
* Download distribution from [Apache](http://www.apache.org/dyn/closer.cgi/hbase/) and extract to home. Rename the folder to `hbase`.
* Modify `hbase-site.xml` as mentioned in [here](https://hbase.apache.org/book.html#quickstart)

**Spark**
* Download zip from [here](https://spark.apache.org/downloads.html) & extract to home. Rename the folder to `spark`.
...
Check out the [source code](https://github.com/scriperdj/import-csv-to-hbase-spark/blob/master/src/main/java/examples/spark/ImportCsvToHBase.java) for implementation details.
...
![YARN](/images/posts/Screenshot-2017-9-24.png)
